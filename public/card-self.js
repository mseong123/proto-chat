...
;var locals_for_with = (locals || {});(function (Date, String, value) {;pug_debug_line = 1;pug_debug_filename = ".\\views\\component\u002Fcard-self.pug";
...
pug_html = pug_html + " ";
;pug_debug_line = 8;pug_debug_filename = ".\\views\\component\u002Fcard-self.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = date.getHours()+':'+String(date.getMinutes()).padStart(2, '0')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Date" in locals_for_with?locals_for_with.Date:typeof Date!=="undefined"?Date:undefined,"String" in locals_for_with?locals_for_with.String:typeof String!=="undefined"?String:undefined,"value" in locals_for_with?locals_for_with.value:typeof value!=="undefined"?value:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}