...
pug_html = pug_html + "\u003Cp" + (pug_attr("class", pug_classes([unread>0?'font-weight-bold':'',"mb-0","small","text-truncate","text-truncate-custom"], [true,false,false,false,false]), false, false)) + "\u003E";
;pug_debug_line = 12;pug_debug_filename = "views\\component\\list-group-item.pug";
...
pug_html = pug_html + "\u003Cspan" + (" class=\"badge badge-info badge-pill\""+pug_attr("id", '#unread'+value._id, true, false)) + "\u003E";
;pug_debug_line = 14;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = unread) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
}
else {
;pug_debug_line = 16;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + "\u003Cspan" + (" class=\"badge badge-info badge-pill d-none\""+pug_attr("id", '#unread'+value._id, true, false)) + "\u003E\u003C\u002Fspan\u003E";
}
}
else {
;pug_debug_line = 18;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + "\u003Cdiv class=\"d-flex flex-column mr-auto\"\u003E";
;pug_debug_line = 19;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + "\u003Cp class=\"mb-0\"\u003E";
;pug_debug_line = 19;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = value.nickname) ? "" : pug_interp));
;pug_debug_line = 20;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + "\u003Cspan" + (pug_attr("class", pug_classes(['badge-'+status,"badge-custom"], [true,false]), false, false)+pug_attr("id", 'badge'+value._id, true, false)) + "\u003E\u003C\u002Fspan\u003E\u003C\u002Fp\u003E";
;pug_debug_line = 21;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + "\u003Cp class=\"mb-0 small text-truncate text-truncate-custom\"\u003E\u003C\u002Fp\u003E";
;pug_debug_line = 22;pug_debug_filename = "views\\component\\list-group-item.pug";
pug_html = pug_html + "\u003Cspan" + (" class=\"badge badge-info badge-pill d-none\""+pug_attr("id", '#unread'+value._id, true, false)) + "\u003E\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
}
