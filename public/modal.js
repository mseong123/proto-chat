...
pug_html = pug_html + "\u003Cp class=\"mb-0 mr-auto\"\u003E";
;pug_debug_line = 4;pug_debug_filename = "views\\component\\card-self.pug";
...
var date= new Date(new Date(value.time).toLocaleString('en-US', { timeZone: 'Asia/Singapore'}))
pug_html = pug_html + "\u003C\u002Fp\u003E";
;pug_debug_line = 10;pug_debug_filename = "views\\component\\card-self.pug";
pug_html = pug_html + "\u003Cp class=\"mb-0 text-nowrap\"\u003E";
;pug_debug_line = 11;pug_debug_filename = "views\\component\\card-self.pug";
pug_html = pug_html + "\u003Cspan class=\"small\"\u003E";
;pug_debug_line = 11;pug_debug_filename = "views\\component\\card-self.pug";
pug_html = pug_html + " ";
;pug_debug_line = 11;pug_debug_filename = "views\\component\\card-self.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = date.getHours()+':'+String(date.getMinutes()).padStart(2, '0')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
;pug_debug_line = 12;pug_debug_filename = "views\\component\\card-self.pug";
pug_html = pug_html + "&nbsp;";
;pug_debug_line = 13;pug_debug_filename = "views\\component\\card-self.pug";
...
var date= new Date(new Date(value.time).toLocaleString('en-US', { timeZone: 'Asia/Singapore'}))
pug_html = pug_html + "\u003C\u002Fp\u003E";
;pug_debug_line = 10;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + "\u003Cp class=\"mb-0 text-nowrap\"\u003E";
;pug_debug_line = 11;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + "\u003Cspan class=\"small\"\u003E";
;pug_debug_line = 11;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + " ";
;pug_debug_line = 11;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = date.getHours()+':'+String(date.getMinutes()).padStart(2, '0')) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
;pug_debug_line = 12;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + "&nbsp;";
;pug_debug_line = 13;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + "\u003Cspan class=\"small-custom\"\u003E";
;pug_debug_line = 13;pug_debug_filename = "views\\component\\card-not-self.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = date.getDate()+' '+date.toLocaleString('default', { month: 'long' }).substring(0,3)+' '+date.getFullYear().toString().substr(-2)) ? "" : pug_interp));
;pug_debug_line = 13;pug_debug_filename = "views\\component\\card-not-self.pug";
