...
pug_html = pug_html + "\u003Cbutton" + (" class=\"btn btn-dark\""+" type=\"button\" onclick=\"formOnClick(event)\""+pug_attr("id", 'submit'+value._id, true, false)+pug_attr("data-socket", value.socketID, true, false)) + "\u003E";
